...
def create_calendar(year=None, month=None):
    ...
    row = [{"text": "<", "callback_data": create_callback_data("PREV-MONTH", year, month, day)},
           {"text": " месяц ", "callback_data": data_ignore},
           {"text": ">", "callback_data": create_callback_data("NEXT-MONTH", year, month, day)}]
    row1 = [{"text": "<", "callback_data": create_callback_data("PREV-YEAR", year, month, day)},
           {"text": " год ", "callback_data": data_ignore},
           {"text": ">", "callback_data": create_callback_data("NEXT-YEAR", year, month, day)}]       
    markup["inline_keyboard"].append(row)
